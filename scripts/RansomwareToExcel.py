...
families_ransomware = ['ryuk', 'sodinokibi', 'babuk', 'avaddon', 'xmrig', 'conti', 'darkside', 'egregor', 'ransomexx_lin', 'ransomexx_win', 'thanos', 'mountlocker', 'mespinoza', 'locky', 'ragnarlocker', 'suncrypt', 'dharma', 'hellokitty', 'nemty', 'teslacrypt', 'jigsaw', 'wannacry', 'djvu', 'nefilim', 'cerber', 'magniber', 'infinitylock', 'lockbit', 'makop', 'buran', 'matrix', 'prometheus', 'hakbit', 'phobos', 'seon', 'gandcrab', 'troldesh', 'badrabbit', 'hanta', 'legionlocker', 'snatch', 'ouroboros', 'dearcry']

def main():
    #Insert your private key
    key = ""

    for family in families_ransomware:
        print(family + ":")
        ...
        try:
            ...
            for item in r['data']:
                ...
                if(found_id == 1):
                    ...
                    excel_final.save("./new_ransomware.xlsx")
